...
################################################
# Tool to program a consoledemo on Karo TX28   #
...
#1.5 - 26.05.2015 - add ETV570                 #
################################################

clear
echo "Program Consoledemo to TX28"
echo "---------------------------"
echo
#Presetting
...
rootfs=mucross-2.0-console-image-tx28.ubi   #Consoledemo
echo
#preparation
echo "Please check:"
...
#add ETV570 if "y" was pressed unintenionally
