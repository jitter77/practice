...
################################################
# Tool to program a polytouchdemo on Karo TX5A #
...
#History                                       #
#----------------------------------------------#
#0.1 - 24.09.2015 - Initial Version            #
################################################

clear
echo "Program Polytouchdemo to TX5A(5010)"
echo "-----------------------------------"
echo
#Presetting
...
echo "module TX5A (TX5A-5010) inserted?"
